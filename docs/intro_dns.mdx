...
ob er die IP-Adresse für www.campus02.at kennt. Wenn nicht, ...
...
Sie können eine Verbindung zu diesem Rechner aufbauen. <img alt="Happy dancing banana" src={useBaseUrl('img/banana.gif')} height='30'/>
