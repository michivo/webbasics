...
zu einer Überschrift oder einem Absatz) weder Anfang noch Ende.</p>
```

Hier ist das HTML-Dokument als JSFiddle:
<iframe width="100%" height="250" src="//jsfiddle.net/michivo/f50y1cp8/3/embedded/html,result/dark/" allowfullscreen="allowfullscreen" frameborder="0"></iframe>
...
```
<a href="https://www.campus02.at" target="_blank">Link zum Campus 02, öffnet sich in einem neuen Tab</a><br>
<script src="jquery.js" async></script> <!-- das Skript jquery.js soll asynchron (async) geladen werden -->
...
In diesem Beispiel ist auch ein Kommentar zu sehen, Kommentare in HTML beginnen mit `<!--` und enden mit `-->`.
